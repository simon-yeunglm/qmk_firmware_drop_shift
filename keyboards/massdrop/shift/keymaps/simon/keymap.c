...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          THANKS , KC_VOLU, KC_VOLD, KC_MPLY, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,CTL_MINS,CTL_PLUS, KC_DEL ,          KC_NLCK, THANKS , ENCRYPT, _______, \
        KC_F6  , L_PSD,   L_BRI,   L_PSI,   L_EDG_I, _______, _______, _______, U_T_AGCR,TG_NKRO, _______, _______,CTL_RBRC, _______,          _______, _______, _______, _______, \
        KC_CAPS, L_PTP,   L_BRD,   L_PTN,   L_EDG_D, _______, _______, L_RATIOD,L_RATIOI,DBG_LED, _______, _______, _______,                   _______, _______, _______, _______, \
        _______, L_T_MD,  L_T_ONF, _______, L_EDG_M, MD_BOOT, CTL_N  , _______, _______, _______, _______, _______,                            _______, _______, _______,          \
                                                                                                                             KC_PGUP,                                     _______, \
        _______, _______, _______,                   DBG_FAC,                            KC_APP,  _______,                                              KC_INS , _______,          \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    if (!led_process_record(keycode, record))
        return false;
...
//            return false;
        ...
        case DBG_LED:
            if (record->event.pressed) {
				led_mfg_test_mode = led_mfg_test_mode == LED_MFG_TEST_MODE_OFF ? LED_MFG_TEST_MODE_RAWP : LED_MFG_TEST_MODE_OFF;
            }
            return false;
        case CTL_N:
            if (record->event.pressed) {
