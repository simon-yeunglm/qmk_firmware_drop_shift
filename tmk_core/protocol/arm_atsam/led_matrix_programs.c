...
//light blue with moving light blue stripe
led_setup_t leds_blue_with_blue_stripe[] = {
    { .hs = 0, .he = 100,.rs = 5    , .re = 5   , .gs = 25  , .ge = 25  , .bs = 50  , .be = 50 , .ef = EF_NONE },
    { .hs = 0, .he = 15, .rs = 0    , .re = 60  , .gs = 0   , .ge = 90  , .bs = 0   , .be = 100, .ef = EF_SCR_R },
    { .hs = 15,.he = 30, .rs = 60   , .re = 0   , .gs = 90  , .ge = 0   , .bs = 100 , .be = 0  , .ef = EF_SCR_R },
    { .end = 1 },
};

void *led_setups[] = {
    leds_blue_with_blue_stripe,
//    leds_rainbow_s,
//    leds_rainbow_ns,
//    leds_teal_salmon,
//    leds_yellow,
